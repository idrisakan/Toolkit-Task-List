  ...
  return (
    <div>
      <Container>
        ...
        <Table striped bordered hover responsive variant={isDarkTheme ? 'dark' : 'light'}>
          <thead>
            <tr>
              <th>#</th>
              <th>Görev</th>
            ...
            {tasks.map((task, i) => (
              <tr key={task.id}>
                ...
                <Stack direction='horizontal' gap={1}  >
                  ...
                  className='d-grid place-items-center'><FaEdit />
                  </Button>
                  <Button onClick={() => dispatch(deleteTask(task.id))}
                  className='d-grid place-items-center' variant='danger'><FaTrashAlt />
                  </Button>
